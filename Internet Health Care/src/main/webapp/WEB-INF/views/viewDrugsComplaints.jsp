	...
	<div class="navbar navbar-custom navbar-fixed-top">
		...
		<div class="col-md-8">
			<form:form method = "POST" action="message.htm">
    			...
    			<c:forEach var="complaintList" items="${requestScope.complaintList}">	
    				<tbody>
        				<tr>
            				<td>${complaintList.drugName}</td>
            				<td>${complaintList.drugType}</td>
            				<td>${complaintList.manufacturerName}</td>
            				<td>${complaintList.enterComplaint}</td>
            				<td>${complaintList.severityLevel}</td>
